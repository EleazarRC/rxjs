...
import { interval, timer, concatMap, concat, merge, combineLatest } from 'rxjs';
...
(() =>{
    ...
    // Emite números del 1 al 5 cada segundo, pero tiene un delay inicial
    // de 500 milésimas 
